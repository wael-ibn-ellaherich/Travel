package tn.esprit.TRAVELGO.security;
...
import tn.esprit.TRAVELGO.security.jwt.AuthEntryPointJwt;
import tn.esprit.TRAVELGO.security.jwt.AuthTokenFilter;
import tn.esprit.TRAVELGO.security.services.UserDetailsServiceImpl;
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable()
             ...
             .authorizeRequests().antMatchers("/api/**",
                    ...
                    "/api/listNews",
                    "/affect-image-to-news/{idimage}/{idnews}",
                    "/api/delete/{newsId}",
                    "/api/active-account",
                    "/upload",
                    "/uploadedn",
